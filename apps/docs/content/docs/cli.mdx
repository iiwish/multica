...
multica issue comment update <comment-id> --content "Check the regression tests and release notes"
...
multica issue comment update <comment-id> --content-file revised-review.md
```
